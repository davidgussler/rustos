...
HD_PWD='/home/david/prj/my_repos/rustos/fpga/vivado/rustos/rustos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rustos_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rustos_fpga_top.tcl
